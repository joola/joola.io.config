...
app.get('/conf/:provider/:env/:id', function (req, res) {
  var filePath = path.resolve(__dirname, storedPath, req.params.provider, req.params.env, req.params.id + '.json');
...
app.get('/conf/:env/:id', function (req, res) {
  var filePath = path.resolve(__dirname, nconf.get('store:path'), req.params.env, req.params.id + '.json');
...
app.get('/conf/:id', function (req, res) {
  var filePath = path.resolve(__dirname, nconf.get('store:path'), req.params.id + '.json');
